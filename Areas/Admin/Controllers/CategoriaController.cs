...
namespace Projeto_Lanchonete.Controllers
{
    ...
    public class CategoriaController : Controller
    {
        ...
        // GET: Categoria
        public async Task<IActionResult> Index(string botao, string? txtFiltro, string? selOrdenacao, int pagina = 1)
        {
            int pageSize = 4; // Número de itens por página

            IQueryable<Categoria> lista = _context.Categoria;
           ...
           if (botao == "Relatorio")
            ...
            if (!string.IsNullOrEmpty(txtFiltro))
            {
                ...
                lista = lista.Where(item => item.CategoriaNome.ToLower().Contains(txtFiltro));
            }
            ...
            {
                lista = lista.OrderByDescending(item => item.CategoriaNome);
            }
